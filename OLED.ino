...
//////////////////////////
#define PIN_RESET 0  // Connect RST to pin 9 (req. for SPI and I2C)
...
// Global variable to track OLED state
int oledState = 0; // off
...
void displayImage() {
 ...
 /*
  ...
  response += "<title>OLED Image ON</title>";
  response += "</head><body>";
  response += "OLED Image On";
  response += "</body></html>";
...
void displayOLEDState() {
  debug("OLED State: ");
  debugln(stateToString(oledState));
}
